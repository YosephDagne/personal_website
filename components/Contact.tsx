  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-linear-to-r from-blue-600 to-cyan-500">
          Get in Touch
        </h1>
        <div className="h-1 w-24 bg-linear-to-r from-blue-500 to-cyan-400 mx-auto mt-4 rounded-full" />
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-12 w-full max-w-6xl">
        ...
        <div className="flex flex-col gap-8 w-full lg:w-1/2  lg:p-8 bg-gray-100 dark:bg-gray-800 rounded-lg pl-0">
          <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-linear-to-r from-blue-700 to-cyan-500">
            Let&apos;s Talk
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full h-40 px-5 py-3 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-800 dark:text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              />
            </div>

            <button
              type="submit"
              className="w-full py-3 px-6 text-lg font-medium rounded-lg bg-linear-to-r from-blue-600 to-cyan-500 text-white shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-cyan-600 transition-all"
            >
              Send Message
            </button>
          </div>
...
const InputField = ({
  ...
  <div>
    ...
    <input
      ...
      onChange={onChange}
      className="w-full px-5 py-3 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-800 dark:text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
    />
  </div>
);
