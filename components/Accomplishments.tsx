  ...
  return (
    ...
    >
      <div className="text-center mt-32 max-w-5xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center bg-linear-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
          Accomplishments
        </h2>
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 gap-10">
          {accomplishments.map((item, index) => (
            ...
            hover:border-blue-400/50 hover:shadow-blue-500/20 text-center 
            ...
            >
              ...
              <p className="text-6xl font-extrabold bg-linear-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
                {item.value}
              </p>
