          ...
          {educationList.map((edu, index) => (
            <motion.div
              ...
              className="relative bg-gray-200 dark:bg-gray-800/30 backdrop-blur-lg
                p-8 rounded-2xl shadow-lg hover:shadow-blue-500/30
                border border-white/20 dark:border-gray-700/40
                hover:border-blue-400/60 transition-all duration-300"
            >
              ...
              <span
                ...
                rounded-full bg-blue-100 dark:bg-blue-900/60 text-blue-700 dark:text-blue-300"
              >
                {edu.year}
              </span>
