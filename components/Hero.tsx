  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-gray-100 mb-4">
        <span className="bg-linear-to-r from-blue-600 to-cyan-400 text-transparent bg-clip-text"> Hey !
          I&apos;m Yosef Dagne
        </span>
      </h1>
      ...
      <h2 className="text-2xl sm:text-3xl font-bold text-gray-700 dark:text-gray-300 h-12">
        <span className="bg-linear-to-r from-blue-600 to-sky-500 text-transparent bg-clip-text">
          {currentText}
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-6">
        <AnchorLink
          offset={50}
          href="#contact"
          className="px-6 py-3 sm:px-4 sm:py-2 bg-linear-to-r from-cyan-500 to-blue-700 
        ...
        <a
          ...
          download
          className="px-6 py-3 sm:px-4 sm:py-2 bg-linear-to-r from-blue-500 to-sky-500 
                     text-white text-lg sm:text-base rounded-full transition-all duration-300 
                     hover:scale-110 shadow-md cursor-pointer border border-transparent 
                     hover:border-white text-center"
        >
